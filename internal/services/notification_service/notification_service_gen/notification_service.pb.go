...
const file_notification_service_proto_rawDesc = "" +
	...
	"\x03fee\x18\x04 \x01(\x01R\x03fee2\x7f\n" +
	"\x13NotificationService\x126\n" +
...
var file_notification_service_proto_goTypes = []any{
	...
	(*DeliverRequest)(nil), // 1: notif.DeliverRequest
	(*SellRequest)(nil),    // 2: notif.SellRequest
}
var file_notification_service_proto_depIdxs = []int32{
	1, // 0: notif.NotificationService.DeliverNotif:input_type -> notif.DeliverRequest
	2, // 1: notif.NotificationService.SellNotif:input_type -> notif.SellRequest
	0, // 2: notif.NotificationService.DeliverNotif:output_type -> notif.Response
	0, // 3: notif.NotificationService.SellNotif:output_type -> notif.Response
